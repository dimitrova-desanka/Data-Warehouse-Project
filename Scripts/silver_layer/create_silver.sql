...
================================
Purpose:
This script creates tables in the Silver schema, while also droppping existing tables beforehand.
...
Run this script again to re-define the DDL structure of the Silver tables.
=============================================================================================================
*/
...
CREATE TABLE silver.crm_product_info (
	...
	prd_line NVARCHAR(50), -- example: M, R, S or T (4 options total) -- moved this up to group it with the related columns, and before name because it's more aggregate.
	...
	prd_end_date_original DATE, -- example: 12 28 2007 --  original end date, which is older than the start date. This seems like invalid data, but is kept for reference.
...
CREATE TABLE silver.crm_sales_details (
	...
	sls_quantity_new INT,
	sls_quantity_original INT, -- example: 10
	sls_price_new INT,
	sls_price_original INT, -- example: 3578
	sls_sales_new INT,
	sls_sales_original INT, -- example: 3578
	dwh_create_date DATETIME2 DEFAULT GETDATE()
);
