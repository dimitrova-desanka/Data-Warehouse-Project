...
================================
Purpose:
This script creates tables in the Bronze schema, while also droppping any existing tables beforehand.
There are 6 tables in total, one for each CSV file from the source systems CRM and ERP (each with 3 tables).
Please note that this DDL script creates empty tables without data, which will be populated in a later step.
Run this script again to re-define the DDL structure of the Bronze tables.
=============================================================================================================
*/
